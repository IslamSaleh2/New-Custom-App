define("UsrRealty_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "d5d4664e-0794-8aa4-cba9-3d6a5b888d99",
							"code": "PDS_UsrPrice",
						...
						{
							"id": "bb6f9453-6c21-73b6-e624-7b4af52a00ff",
							"code": "PDS_UsrColumn4",
						...
						{
							"id": "6f0d68e4-c680-1fa5-aba2-c8cb4bec224d",
			...
			{
				"operation": "insert",
				"name": "QuickFilter_qt01oi5",
				"values": {
					"type": "crt.QuickFilter",
					"config": {
						"caption": "#ResourceString(QuickFilter_qt01oi5_config_caption)#",
						"hint": "",
					...
					"_filterOptions": {
						"expose": [
							{
								"attribute": "QuickFilter_qt01oi5_Items",
								"converters": [
									{
						...
						"from": "QuickFilter_qt01oi5_Value"
					},
					"filterType": "lookup"
				},
			...
			},
			{
				...
				"values": {
					"filterAttributes": [
						...
						{
							"name": "QuickFilter_qt01oi5_Items",
							"loadOnChange": true
						}
					]
				}
